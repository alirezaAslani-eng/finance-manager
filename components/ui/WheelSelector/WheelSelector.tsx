...
const sx_shadowBox: SxProps<Theme> = (tm: Theme) => {
  ...
  return {
    "::after": {
      ...
      height: "25%",
      zIndex: "3",
      backgroundImage: `linear-gradient(180deg, ${palette.background.paper} 30%, ${alpha(palette.background.paper, 0.5)}, ${alpha(palette.background.paper, 0)})`,
      top: 0,
      left: 0,
      pointerEvents: "none",
    },
    "::before": {
      ...
      height: "25%",
      zIndex: "3",
      backgroundImage: `linear-gradient(0deg, ${palette.background.paper} 30%, ${alpha(palette.background.paper, 0.5)}, ${alpha(palette.background.paper, 0)})`,
      bottom: 0,
      left: 0,
      pointerEvents: "none",
    },
